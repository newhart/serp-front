  ...
  <div class="">
    <v-card class="card-default pa-3">
      <v-img
        height="300"
        width="100%"
        :src="image ? image : '/img/default-group.jpg'"
        :lazy-src="image ? image : '/img/default-group.jpg'"
      ...
      <v-tabs
        ...
        class="tabs-groups"
      >
        <v-tab class="tab-group"> À propos </v-tab>
...
export default {
  ...
  mounted() {
    this.$axios
      .get("api/groups/suggest-friend")
      .then((res) => {
        this.all_friends = res.data;
      })
      .catch((error) => {
        console.error(error);
      });
